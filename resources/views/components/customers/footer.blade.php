<footer class="bg-slate-950">
  <div class="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 lg:px-8">
    ...
    <div class="mt-4 text-center sm:text-right">
      <!-- masukkan nomor wa admin disini -->
      <a 
        href="https://wa.me/6281234567890" 
        class="text-slate-100 hover:text-pink-500 flex items-center space-x-2" 
        target="_blank"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill-rule="evenodd" clip-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" viewBox="0 0 13333.33 13333.33" id="whatsapp">
